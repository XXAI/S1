...
export const APPS:App [] = [
    ...
    { name:"Quejas Médicas y Administrativas",          route: "lista-quejas-sugerencias-generales",         icon: "assets/icons/mail-box.png",       permission:"" },
    { name:"Quejas Vehiculares",        route: "lista-quejas-sugerencias-vehiculares",       icon: "assets/icons/ambulancia.svg",       permission:"" },
